        ...
        >
          ...
          <div className='relative flex min-w-0 max-w-full grow flex-col overflow-y-auto px-4 md:px-6'>
            ...
            {methodId === 'card-transfer' && adjustedAmount >= 10000 ? (
              <div className="relative mt-6 flex h-[220px] max-w-full shrink-0 overflow-hidden rounded-xl bg-zinc-800 p-4 before:absolute before:bottom-0 before:right-0 before:h-full before:w-[196px] before:bg-[url('data:image/png;base64,INSERT_YOUR_BASE64_HERE')] before:bg-cover before:content-[''] lg:max-w-[277px] xl:max-w-[343px]">
                <div className='flex h-full max-w-36 flex-col items-start'>
                  ...
                  <div className='mt-4 flex items-center gap-2 text-base font-semibold tracking-tight text-white'>
                    Поддержка
                ...
                <img
                  ...
                  width={164}
                  height={164}
                  src='/assets/support.png' // Замените на ваш путь к изображению
